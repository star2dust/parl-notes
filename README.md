...
<img src="figures/bear_tree.png" alt="rl_value" width="450"/>

强化学习主要解决的是Model-free的情况，即P函数和R函数都未知的情况。这时我们用价值V代表某一状态的好坏，用Q函数来代表某个状态下哪个动作更好，即状态动作价值。

<img src="figures/model_free.png" alt="rl_value" width="450"/>
...
<img src="figures/q_td.png" alt="rl_value" width="400"/>
...
<img src="figures/e_greedy.png" alt="rl_value" width="350"/>
...
<img src="figures/qlearning_sarsa_learn.png" alt="rl_value" width="400"/>

二者算法对比如下图所示，有三处不同点。

<img src="figures/qlearning_sarsa.png" alt="rl_value" width="500"/>